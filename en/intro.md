...
**DeskBoy** takes your bookings from the channel you use (**Hosthub**, **Hospitable**, **Smoobu**, **Lodgify**, **Hostaway**, **Airbnb** directly and other channels) and handles everything that follows: the tax documents in **Elorus** with submission to **myDATA**, the **Short-Term Stay Declaration** to **AADE**, and the **Climate Resilience Fee** together with its monthly payment declaration. Automatically, for every booking.
...
- **Property managers** with many properties on Hosthub, Hospitable, Smoobu, Lodgify, Hostaway or another channel, losing hours to invoicing and declarations
