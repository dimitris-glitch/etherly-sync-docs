...
If you rent out your properties as a private individual, you have two obligations: the **Short-Term Stay Declaration** for every booking, and paying the **Climate Resilience Fee**. The app covers both.

## What the app does for you

- **Collects your bookings** from the channels you have connected.
- **Submits declarations to AADE** — automatically or with your approval, whichever you choose under Declarations.
- **Calculates the Climate Resilience Fee** per month, in the layout of the AADE form (see [Climate Resilience Fee](/en/guides/climate-fee)).

You do not need to connect an invoicing provider: as a private individual you do not issue documents, so the app goes straight to the declaration.
