...
<Steps>
  <Step title="Verify email">
    After signing up you receive a confirmation email. Click the link to verify your email. (You can request a resend if it doesn't arrive.)
  </Step>
  ...
  <Step title="Connect your channel manager">
    Choose the channel manager you use — Hosthub, Airbnb, Hospitable, Smoobu, Lodgify, or Hostaway — and connect it so your bookings sync. For Airbnb, no API key is needed — DeskBoy connects directly to your Airbnb account.
  </Step>
